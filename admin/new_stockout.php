...
if (isset($_POST['submit'])) {
    ...
    $insert=$conn->query("INSERT INTO stock_out(product_id,quantity) VALUES('$pid','$quantity')");
    if ($update AND $insert) {
        header("location:stock_out.php");
    }
    else{
        header("location:new_stockout.php?error=product not removed from stock");
    }
    ...
    <a  class="btn btn-primary btn-sm col-4" href="logout.php"><i class="fa-solid fa-power-off"></i>&nbsp;Yes</a>
            ...
            <div class="col-sm-7 mt-3">
              <div class="row m-2 p-4 ms-7 justify-content-center align-items-center">
                <div class="card">
                  <div class="card-header"> <center><div><i class="fa-solid fa-cart-arrow-down"></i>&nbsp;New stock out</div></center></div>
                  <div class="card-body">
                  <div class="col-sm-12 ">
               ...
               <?php
                   ...
                   <center><button type="submit" name="submit" class="btn  btn-sm col-5 btn-danger"><i class="fa-solid fa-minus"></i>&nbsp;Remove</button></center>
               </form>
            </div>
                  </div>
                </div>
