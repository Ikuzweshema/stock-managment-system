    ...
    <a  class="btn btn-primary btn-sm col-4" href="logout.php"><i class="fa-solid fa-power-off"></i>&nbsp;Yes</a>
            ...
            <div class="row m-2 p-4 ms-7">
              <div class="card">
                ...
                <center><div><i class="fa-solid fa-cart-plus"></i>&nbsp;stock in</div></center>
                </div>
                <div class="card-body">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <?php
                        $select_stock_in=$conn->query("SELECT stock_in.*, products.product_name, products.unit_price from stock_in INNER JOIN products ON stock_in.product_id = products.product_id   order by stock_in.stock_in_date  desc");
                  ...
                  <center><a href="new.php" class="btn btn-danger col-4 btn-sm"><i class="fa-solid fa-plus col-5 btn-sm"></i>&nbsp;New stock in</a></center>
             </div>
                </div>
              </div>
