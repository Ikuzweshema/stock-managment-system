...
if(isset($_POST['submit'])){
    ...
    $insert=$conn->query("INSERT INTO products(product_name,unit_price) VALUES('$pname','$price')");
...
<div class="modal-content">
  ...
  <div class="modal-footer d-flex justify-content-center">
    ...
    <a  class="btn btn-primary btn-sm col-4" href="logout.php"><i class="fa-solid fa-power-off"></i>&nbsp;Yes</a>
            ...
            <div class="card">
              <div class="card-header"> <center><div><i class="fa-solid fa-cart-plus"></i>&nbsp;Add product</div></center></div>
              <div class="card-body">
              <div class="col-sm-12 ">
               ...
               <?php
                   ...
                   <div class="input-group mb-3">
                       ...
                       <input type="text" placeholder="Enter product price per kg..." name="price" class="form-control">
                   </div>
                   
                   <center><button type="submit" name="submit" class="btn btn-danger btn-sm col-5"><i class="fa-solid fa-plus"></i>Add</button></center>
               </form>
            </div>
              </div>
            </div>
